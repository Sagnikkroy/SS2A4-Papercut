...
A utility to combine multiple screenshots into a single, well-formatted A4 PDF. It features a GUI for selecting files, arranging their order, and automatically handles pagination and scaling.
I use this for my University labs but I think this is an useful tool and can be used for many purposes so I put it here.
...
2.add images
3.arrage
4.select location where you want to save
5.generate
